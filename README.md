...
| Language | Creator        | Year     | Organization     | Purpose                            |
| -------- | -------------- | -------- | ---------------- | ---------------------------------- |
| **C**    | Dennis Ritchie | **1972** | Bell Labs        | System programming (UNIX)          |
| **Java** | James Gosling  | **1995** | Sun Microsystems | Platform-independent, OOP language |
